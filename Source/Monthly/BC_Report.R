...
write.xlsx(as.data.frame(od_bq_rpt), file="Output/MSR_Report_all_feb24.xlsx", sheetName="Bouquet", row.names=FALSE)
write.xlsx(as.data.frame(od_al_rpt), file="Output/MSR_Report_all_Feb24.xlsx", sheetName="Alacarte", append=TRUE, row.names=FALSE)
