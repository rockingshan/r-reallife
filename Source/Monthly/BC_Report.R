...
write.xlsx(as.data.frame(od_bq_rpt), file="Output/MSR_Report_all_Dec22.xlsx", sheetName="Odisha_Bouquet", row.names=FALSE)
write.xlsx(as.data.frame(od_al_rpt), file="Output/MSR_Report_all_Dec22.xlsx", sheetName="Odisha_Alacarte", append=TRUE, row.names=FALSE)
write.xlsx(as.data.frame(wbbqt_active_pivot), file="Output/MSR_Report_all_Dec22.xlsx", sheetName="WB_Bouquet", append=TRUE,row.names=FALSE)
write.xlsx(as.data.frame(active_pivot_ala_wb), file="Output/MSR_Report_all_Dec22.xlsx", sheetName="WB_Alacarte", append=TRUE, row.names=FALSE)
